const translations = {
    pt: {
        ...
        c1_title: "Defesa (SecOps)", c1_desc: "Liderança de equipas L1, redução do MTTR em 15% e otimização de deteção em plataformas SIEM/XDR.",
        c2_title: "Engenharia", c2_desc: "Arquitetura e implementação de playbooks SOAR (Thycotic) e integração via API para automação.",
        c3_title: "Security Assessment", c3_desc: "Avaliações OWASP e testes para identificar caminhos de ataque (Red Team) e falhas em aplicações.",
        c4_title: "Vulnerability Management", c4_desc: "Programa proativo com Tenable.io e Landsweeper; remediação de +500 vulnerabilidades críticas.",
        c5_title: "Network Security", c5_desc: "Implementação de Darktrace e gestão de segurança de perímetro com Palo Alto.",
        c6_title: "Cloud Security", c6_desc: "Onboarding de 2000+ endpoints (Defender/Intune) e redução de incidentes de malware em 40%.",
        c7_title: "Compliance", c7_desc: "Auditorias técnicas e evidências para PCI DSS, NIS2, GDPR e certificação ISO27001.",
        c8_title: "Software", c8_desc: "Gestão e integração de soluções complexas: ArcSight, Cortex XDR, Sentinel, Fortify e Sealpath.",
        c9_title: "Programming", c9_desc: "Automação com Python e desenvolvimento Full-Stack para ferramentas de segurança personalizadas.",
        c10_title: "IAM", c10_desc: "Aplicação de políticas unificadas de identidade e acesso no ecossistema Microsoft Security.",
        c11_title: "Reporting", c11_desc: "Relatórios detalhados com orientações prescritivas (Blue Team) e documentação de ataque.",
        c12_title: "Asset Management", c12_desc: "Visibilidade total e inventário de ativos críticos utilizando Landsweeper e Tenable.",
        c13_title: "Threat Intelligence (CTI)", c13_desc: "Recolha estratégica de informação para antecipar TTPs e fortalecer defesas proativamente.",
        c14_title: "Threat Hunting", c14_desc: "Investigação proativa de ameaças sofisticadas não detetadas por alertas padrão.",
        c15_title: "Digital Forensics", c15_desc: "Análise forense para determinação de causa raiz e reconstrução de incidentes complexos.",
    ...
    en: {
        ...
        c1_title: "Defense (SecOps)", c1_desc: "Leading L1 teams with 15% MTTR reduction and optimizing detection across SIEM/XDR platforms including ArcSight, Cortex XDR, and Sentinel.",
        c2_title: "Security Engineering", c2_desc: "Architecting SOAR playbooks with Thycotic and building API integrations for comprehensive security automation and orchestration.",
        c3_title: "Security Assessment", c3_desc: "OWASP-based assessments and penetration testing to identify attack paths and application vulnerabilities with prescriptive remediation guidance.",
        c4_title: "Vulnerability Management", c4_desc: "Proactive security program leveraging Tenable.io and Landsweeper with successful remediation of 500+ critical vulnerabilities.",
        c5_title: "Network Security", c5_desc: "Implementation of Darktrace and perimeter security management with Palo Alto.",
        c6_title: "Cloud Security", c6_desc: "Securing 2000+ endpoints using Microsoft Defender and Intune, achieving 40% reduction in malware incidents across enterprise infrastructure.",
        c7_title: "Compliance", c7_desc: "Technical audits and evidence for PCI DSS, NIS2, GDPR, and ISO27001 certification.",
        c8_title: "Software", c8_desc: "Management and integration of complex solutions: ArcSight, Cortex XDR, Sentinel, Fortify, and Sealpath.",
        c9_title: "Programming", c9_desc: "Automation with Python and Full-Stack development for custom security tools.",
        c10_title: "IAM", c10_desc: "Enforcement of unified identity and access policies within the Microsoft Security ecosystem.",
        c11_title: "Reporting", c11_desc: "Detailed reports with prescriptive guidance (Blue Team) and attack documentation.",
        c12_title: "Asset Management", c12_desc: "Full visibility and inventory of critical assets using Landsweeper and Tenable.",
        c13_title: "Threat Intelligence (CTI)", c13_desc: "Strategic information gathering to anticipate TTPs and proactively strengthen defenses against emerging global cyber threats.",
        c14_title: "Threat Hunting", c14_desc: "Proactive investigation of sophisticated threats undetected by standard alerts.",
        c15_title: "Digital Forensics", c15_desc: "Forensic analysis for root cause determination and reconstruction of complex incidents.",
